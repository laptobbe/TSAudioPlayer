#
#  Be sure to run `pod spec lint TSAudioPlayer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://www.computertalk.se/TSAudioPlayer"
  ...
  # Or just: s.author    = "Tobias Sundstrand"
  # s.authors            = { "Tobias Sundstrand" => "tobias.sundstrand@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Tobias Sundstrand"
  ...
  s.source       = { :git => "http://EXAMPLE/TSAudioPlayer.git", :tag => "0.0.1" }
